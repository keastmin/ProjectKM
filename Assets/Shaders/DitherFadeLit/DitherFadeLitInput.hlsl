#ifndef PROJECTKM_DITHER_FADE_LIT_INPUT_INCLUDED
#define PROJECTKM_DITHER_FADE_LIT_INPUT_INCLUDED
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _CameraFade)
    UNITY_DOTS_INSTANCED_PROP(float , _FadePower)
    UNITY_DOTS_INSTANCED_PROP(float , _FullFadeThreshold)
...
static float  unity_DOTS_Sampled_CameraFade;
static float  unity_DOTS_Sampled_FadePower;
static float  unity_DOTS_Sampled_FullFadeThreshold;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_CameraFade           = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _CameraFade);
    unity_DOTS_Sampled_FadePower            = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _FadePower);
    unity_DOTS_Sampled_FullFadeThreshold    = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _FullFadeThreshold);
}
...
#define _CameraFade             unity_DOTS_Sampled_CameraFade
#define _FadePower              unity_DOTS_Sampled_FadePower
#define _FullFadeThreshold      unity_DOTS_Sampled_FullFadeThreshold
#endif
